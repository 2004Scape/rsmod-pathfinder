export default class RouteCoordinates {
    ...
    constructor(x: number, z: number, level: number) {
        this.packed = (z & RouteCoordinates.COORD_MASK) | ((x & RouteCoordinates.COORD_MASK) << RouteCoordinates.X_BITS) | ((level & RouteCoordinates.LEVEL_MASK) << RouteCoordinates.LEVEL_BITS);
    }
