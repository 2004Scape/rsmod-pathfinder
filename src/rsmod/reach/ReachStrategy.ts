...
export default class ReachStrategy {
    ...
    static reachRectangle(flags: CollisionFlagMap, level: number, srcX: number, srcZ: number, destX: number, destZ: number, srcSize: number, destWidth: number, destHeight: number, angle: number = 0, blockAccessFlags: number = 0): boolean {
        ...
        const collides: boolean = RectangleBoundaryUtils.collides(srcX, srcZ, destX, destZ, srcSize, srcSize, rotatedWidth, rotatedHeight);
    ...
    static reachExclusiveRectangle(flags: CollisionFlagMap, level: number, srcX: number, srcZ: number, destX: number, destZ: number, srcSize: number, destWidth: number, destHeight: number, angle: number = 0, blockAccessFlags: number = 0): boolean {
        const rotatedWidth: number = RotationUtils.rotate(angle, destWidth, destHeight);
        const rotatedHeight: number = RotationUtils.rotate(angle, destHeight, destWidth);
        const rotatedBlockAccess: number = RotationUtils.rotateFlags(angle, blockAccessFlags);
        const collides: boolean = RectangleBoundaryUtils.collides(srcX, srcZ, destX, destZ, srcSize, srcSize, rotatedWidth, rotatedHeight);
    ...
    static reachWall(flags: CollisionFlagMap, level: number, srcX: number, srcZ: number, destX: number, destZ: number, srcSize: number, shape: number, angle: number): boolean {
    ...
    static reachWallDecor(flags: CollisionFlagMap, level: number, srcX: number, srcZ: number, destX: number, destZ: number, srcSize: number, shape: number, angle: number): boolean {
        if (srcSize === 1 && srcX === destX && srcZ === destZ) {
            return true;
        } else if (srcSize !== 1 && destX >= srcX && srcSize + srcX - 1 >= destX && destZ >= srcZ && srcSize + srcZ - 1 >= destZ) {
            return true;
    ...
    static reachWall1(flags: CollisionFlagMap, level: number, srcX: number, srcZ: number, destX: number, destZ: number, shape: number, angle: number): boolean {
    ...
    static reachWallN(flags: CollisionFlagMap, level: number, srcX: number, srcZ: number, destX: number, destZ: number, srcSize: number, shape: number, angle: number): boolean {
        const collisionFlags: number = flags.get(srcX, srcZ, level);
    ...
    static reachWallDecor1(flags: CollisionFlagMap, level: number, srcX: number, srcZ: number, destX: number, destZ: number, shape: number, angle: number): boolean {
        const collisionFlags: number = flags.get(srcX, srcZ, level);
        if (shape === 6 || shape === 7) {
    ...
    static reachWallDecorN(flags: CollisionFlagMap, level: number, srcX: number, srcZ: number, destX: number, destZ: number, srcSize: number, shape: number, angle: number): boolean {
        const collisionFlags: number = flags.get(srcX, srcZ, level);
        const east: number = srcX + srcSize - 1;
        const north: number = srcZ + srcSize - 1;
        if (shape === 6 || shape === 7) {
