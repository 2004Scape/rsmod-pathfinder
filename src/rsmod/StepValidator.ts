...
export default class StepValidator {
    ...
    canTravel(level: number, x: number, z: number, offsetX: number, offsetZ: number, size: number, extraFlag: number, collision: CollisionStrategy): boolean {
        let blocked: boolean;
    ...
    isBlockedSouth(level: number, x: number, z: number, size: number, extraFlag: number, collision: CollisionStrategy): boolean {
        switch (size) {
            case 1:
            ...
            default:
                ...
                for (let midX: number = x + 1; midX < x + size - 1; midX++) {
    ...
    isBlockedNorth(level: number, x: number, z: number, size: number, extraFlag: number, collision: CollisionStrategy): boolean {
        switch (size) {
            case 1:
    ...
    isBlockedWest(level: number, x: number, z: number, size: number, extraFlag: number, collision: CollisionStrategy): boolean {
        switch (size) {
            case 1:
            ...
            default:
                ...
                for (let midZ: number = z + 1; midZ < z + size - 1; midZ++) {
    ...
    isBlockedEast(level: number, x: number, z: number, size: number, extraFlag: number, collision: CollisionStrategy): boolean {
        switch (size) {
            case 1:
    ...
    isBlockedSouthWest(level: number, x: number, z: number, size: number, extraFlag: number, collision: CollisionStrategy): boolean {
        switch (size) {
            case 1:
                return (
            ...
            default:
                ...
                for (let mid: number = 1; mid < size; mid++) {
    ...
    isBlockedNorthWest(level: number, x: number, z: number, size: number, extraFlag: number, collision: CollisionStrategy): boolean {
        switch (size) {
            case 1:
                return (
    ...
    isBlockedSouthEast(level: number, x: number, z: number, size: number, extraFlag: number, collision: CollisionStrategy): boolean {
        switch (size) {
            case 1:
                return (
    ...
    isBlockedNorthEast(level: number, x: number, z: number, size: number, extraFlag: number, collision: CollisionStrategy): boolean {
        switch (size) {
            case 1:
                return (
